document.addEventListener('DOMContentLoaded', () => {
    ...
    const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbyoYBoN9FvojEsg04u8G2u09f-RGDWwpO8g0vFdoLEtFxNKBfzvb6kSLq0CH94J2jkLHA/exec';
    ...
    const addRecordToDOM = (record) => {
        ...
        const moodEmojis = { '행복': '😄', '보통': '😐', '우울': '😔', '다음부터 하지 않을 것임': '😡' };
        const typeText = { 'Cardio': '⛹️‍유산소', 'Weight Training': '🏋🏼 무산소' };
